...
def remove_bad_tweets(tweet):
    bad_words =["ãusgsã","sismos","sismo","fck","stupidity",
                "yikes","nooooooooooooo","nooooo","noooo","nooooooooo","elf","cantwell",
                "debate","booooooooooooooooooooo","madness","ummm","omg","ummmm","stupidville","lolz",
                "sexenio","stupid","dumbest","idiot","stupidtweets","dumb","pleasepleaseplease","bahh"
                "cantwell","anthropology","archeology","assistant" ,"entertainment","cordova","adak",
                "aniak","bethel","hoonah","homer" ,"craig" ,"actor",
                "creator","campaign","wtf","gop","dtn","tou","woul","sup","supe","expe",
                "dog","aaaawwwww","aaaawwww","awwwww","awwwwwwwww","awwwwh",
                "crap","crazy","holy","damn","rtâ","ryâ","welpâ","lame",
